...
export function FaqCtaSection() {
  const waHref = buildWhatsAppLink(
    "Hi Admin Jonifer Seragam, saya ada pertanyaan yang belum terjawab di FAQ."
  );
    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="max-w-md text-sm leading-relaxed text-[#1c1c1c]/70 sm:text-base">
          Kalau jawabannya belum ada di daftar FAQ, langsung tanya admin kami
          lewat WhatsApp, siap bantu tanpa perlu antri.
        </p>
        <a
          href={waHref}
          target="_blank"
